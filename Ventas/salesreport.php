...
<header>
         <nav class="Menu">
                <ul>
                   ...
                   <li><a href="salesreport.php">Reportes</a></li>
               </ul>
           </nav>
       </header>
<br>
<table border="0" align="center" cellpadding="0" cellspacing="0" width="80%">
      ...
      <form action="salesreport.php" method="get" ecntype="multipart/data-form">
        <td width="48%" height="37" align="right"><input type="text" name="d1" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="......." required /></td>
        <td width="15%" align="left"> <input type="text" name="d2" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="......." required  /> </td>
...
<tr>
	<td>
    &copy; 2017 Mr Robot.  |  Designed By:<a href="#">Sirius</a>	
    </td>
</tr>
</table>
</div>
